...
<style>
    ...
    th, td {
        ...
        color: #FFA500; /* Cambiar el color del texto a naranja */
    }
    th {
...
<body>
    ...
    <h1 style="text-align: center; margin-bottom: 20px;"> <p>{c} archivos pendientes de embozado</p> </h1>
    <table>
        <thead>
            {titulos_html}
        </thead>
    ...
    <div style="text-align: center; margin-top: 20px;">
        <p>EMVlab 2.0</p>
         <h1 <p>{c} archivos pendientes de embozado</p></h1>
