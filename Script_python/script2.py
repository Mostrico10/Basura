...
class FileMoverApp:
    def __init__(self, master):
        ...
        # Botón para llamar a Hserver5_21.py
        self.call_hserver_button = tk.Button(master, text="Llamar a Hserver5_21.py", command=self.call_hserver)
        self.call_hserver_button.place(x=350, y=180)
    ...
    def call_hserver(self):
        try:
            subprocess.Popen(["python", "Hserver5_21.py"])
        except Exception as e:
            messagebox.showerror("Error", f"No se pudo llamar a Hserver5_21.py: {str(e)}")
