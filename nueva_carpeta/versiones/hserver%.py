...
<head>
    ...
    <script src=file////\\\\\C:\INPUT\local\jquery.min.js"></script>
...
<body>
    <div id="fixed-block">
        ...
        <table border="10" cellspacing="0" cellpadding="0" bgcolor="#0A0A0A">
            <tr><th>ESTADO 51 JOB PENDIENTES DE EMBOZADO _________FECHA________EXTENSION________DESCRIPCION__________TARJETAS____ESTADO</th></tr>
        </table>
    </div>
